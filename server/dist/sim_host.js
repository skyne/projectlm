...
class SimHost {
    ...
    runAiStrategy() {
        ...
        this.aiStrategy.tick(snapshots, this.runtimeManagedEntryIds, ctx, (entryId, command) => this.session.submitCommand(entryId, command), (entryId) => this.aiStintGuide.getPlan(entryId));
    }
    step() {
